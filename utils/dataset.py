...
def load_data(data_dir, batch_size=16): # Function to load data
    ...
    val_size = int(0.20 * dataset_size) # 20% for validation
    ...
    with open("test/test_set.json", "w") as f: # Save test set indices to a JSON file
        json.dump(test_indices, f)

    print(f"Applying transforms to training and validation sets...")
